  ...
  return (
    <section id="top" className="relative isolate">
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-6xl flex-col items-center justify-center px-5 pb-16 pt-28 text-center sm:px-8">
        ...
        <p className="mt-7 max-w-2xl text-base font-medium leading-relaxed text-white [text-shadow:0_1px_14px_rgba(0,0,0,0.8)] sm:text-lg">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <a href="#first-look" className="btn btn-ghost px-7 py-3 text-base">
            Take the first look
          </a>
        </div>
