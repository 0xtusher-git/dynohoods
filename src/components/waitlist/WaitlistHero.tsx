  ...
  return (
    <section className="relative isolate pt-10 sm:pt-14">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="arcade-title font-brand whitespace-nowrap text-4xl leading-[1.35] tracking-wider text-white [text-shadow:0_2px_18px_rgba(0,0,0,0.75)] sm:text-6xl">
          Join the waitlist
        </h1>
